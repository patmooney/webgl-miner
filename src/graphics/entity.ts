...
import { tileW, SATW } from "../constants";
...
export class EntityGraphics {
    ...
    render(gl: WebGL2RenderingContext, entity: Entity, camera: Vec2D) {
        ...
        gl.uniform2fv(this.binds.move, entity.coords);
        gl.uniform2fv(this.binds.rotation, entity.rotation);
        gl.uniform1f(this.binds.tileW, tileW / 2);
        gl.uniform1i(this.binds.isSelected, entity.id === state.selectedEntity ? 2 : 0);
