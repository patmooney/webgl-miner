...
}`;function G(e){console&&(console.error?console.error(e):console.log&&console.log(e))}const dt=/ERROR:\s*\d+:(\d+)/gi;function V(e,t=""){const i=[...t.matchAll(dt)],o=new Map(i.map((r,s)=>{const a=parseInt(r[1]),c=i[s+1],l=c?c.index:t.length,f=t.substring(r.index,l);return[a-1,f]}));return e.split(`
`).map((r,s)=>{const a=o.get(s);return`${s+1}: ${r}${a?`

^^^ ${a}`:""}`}).join(`
`)}function lt(e,t,i,o){const r=o||G,s=e.createShader(i);if(!s)return r("No shader"),null;if(e.shaderSource(s,t),e.compileShader(s),!e.getShaderParameter(s,e.COMPILE_STATUS)){const c=e.getShaderInfoLog(s);return r(`Error compiling shader: ${c}
${V(t,c??"")}`),e.deleteShader(s),null}return s}function ut(e,t,i,o,r){const s=r||G,a=e.createProgram();if(!a)return null;if(t.forEach(function(l){e.attachShader(a,l)}),i&&i.forEach(function(l,f){e.bindAttribLocation(a,o?o[f]:f,l)}),e.linkProgram(a),!e.getProgramParameter(a,e.LINK_STATUS)){const l=e.getProgramInfoLog(a),f=t.map(D=>{const nt=V(e.getShaderSource(D)??"");return`${e.getShaderParameter(D,e.SHADER_TYPE)}:
${nt}`}).join(`
`);return s(`Error in program linking: ${l}
${f}`),e.deleteProgram(a),null}return a}const ht=["VERTEX_SHADER","FRAGMENT_SHADER"];function g(e,t,i=[],o=[],r=()=>{}){const s=[];for(let a=0;a<t.length;++a)s.push(lt(e,t[a],e[ht[a]],r));return ut(e,s.filter(Boolean),i,o,r)}function z(e,t){t=t||1;const i=e.clientWidth*t|0,o=e.clientHeight*t|0;return e.width!==i||e.height!==o?(e.width=i,e.height=o,!0):!1}const j=async(e,t)=>{const i=e.createTexture()??void 0;if(!i)throw new Error("Invalid texture");e.bindTexture(e.TEXTURE_2D,i);const o=new Image;return o.src=t,new Promise(r=>{o.onload=()=>{e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,o),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.bindTexture(e.TEXTURE_2D,null),r(i)}})},q=""+new URL("atlas-BxrVKyxQ.png",import.meta.url).href,d=40,u=200,ft=6,T=1/ft,A=2,F=10,I={RIGHT:0,LEFT:2,DOWN:1},x={0:0*Math.PI/180,1:90*Math.PI/180,2:180*Math.PI/180,3:270*Math.PI/180},P=360*Math.PI/180,$={FLOOR:0,ROCK:10,ORE:100,SHADOW:0,HOME:0},mt={FLOOR:!0,ROCK:!1,ORE:!1,SHADOW:!1,HOME:!0},m={FLOOR:0,ROCK:1,SHADOW:3,HOME:4,ORE:5},Et={ROCK:[{item:"stone",chance:1},{item:"iron",chance:.02}],ORE:[{item:"stone",chance:.01},{item:"iron",chance:.05},{item:"copper",chance:.02},{item:"carbon",chance:.01}]},yt=e=>Object.entries(m).find(([,t])=>t===e)?.[0]??"FLOOR",K=()=>{const e=u/2-4,t=u/2+4,i=u/2-2,o=u/2+2;let r=[];for(let s=0;s<u*u;s++){const a=s%u,c=Math.floor(s/u);if(c>i&&c<o&&a>i&&a<o){r.push(m.HOME,1);continue}if(c>e&&c<t&&a>e&&a<t){r.push(m.FLOOR,1);continue}if((c===e||c===t)&&a>=e&&a<=t){r.push(m.ROCK,1);continue}if((a===e||a===t)&&c>=e&&c<=t){r.push(m.ROCK,1);continue}r.push(m.SHADOW,1)}return new Float32Array(r)},y=e=>{const[t,i]=e,o=i*u+t,r=S().at(o*A),s=S().at(o*A+1)??0;if(r===void 0)throw new Error(`Invalid tile ${t} / ${i}`);return{coord:e,tile:yt(r),type:r,durability:s}},O=e=>[Math.round(e[0]/d),Math.round(e[1]/d)],pt=e=>{const t=[],[i,o]=e;return i>0&&t.push(y([i-1,o])),i<u-1&&t.push(y([i+1,o])),o>0&&t.push(y([i,o-1])),o<u-1&&t.push(y([i,o+1])),t};let N;const S=()=>(N||(N=K()),N),vt=e=>{const t=S(),[i,o]=e.coord,r=o*u+i;t[r*A]=e.type,t[r*A+1]=e.durability},Z="ACTION_ADD",Q="ACTION_REMOVE";class k{id;type;delta;value;timeEnd;entityId;parentId;isSilent=!1;isComplete=!1;isStarted=!1;isCancelled=!1;shouldCancel=!1;constructor(t,{delta:i,value:o,timeEnd:r,entityId:s},a=!1,c){this.type=t,this.delta=i,this.value=o,this.timeEnd=r,this.entityId=s,this.id=crypto.randomUUID(),this.isSilent=a,this.parentId=c,this.type==="ROTATE"&&(this.value=Math.max(Math.min(3,this.value??0),-3)),this.type==="MOVE"&&(this.value=Math.max(0,Math.min(u,o??0)))}complete(){this.isComplete=!0}start(){this.isStarted=!0}cancel(){this.isStarted?this.shouldCancel=!0:this.isCancelled=!0}}class _t{stack;mapUpdates;hook;constructor(){this.stack=[],this.mapUpdates=[],this.hook=new EventTarget}getActions(){return this.stack.filter(i=>i.isComplete).forEach(i=>{this.hook.dispatchEvent(new CustomEvent(Q,{detail:i}))}),this.stack=[...this.stack.filter(i=>!i.isComplete&&!i.isCancelled)],this.stack}addAction(t,{delta:i,value:o,timeEnd:r,entityId:s}){const a=new k(t,{delta:i,value:o,timeEnd:r,entityId:s});return this.stack.push(a),this.hook.dispatchEvent(new CustomEvent(Z,{detail:a})),a}addSilentAction(t,{delta:i,value:o,timeEnd:r,entityId:s},a){const c=new k(t,{delta:i,value:o,timeEnd:r,entityId:s},!0,a);this.stack.push(c)}cancelOneForEntity(t){const i=this.stack.find(r=>r.entityId===t);if(!i)return;const o=this.stack.filter(r=>r.parentId===i.id);return[i,...o].forEach(r=>r.cancel()),i}cancelAllForEntity(t){this.stack.filter(i=>i.entityId===t).forEach(i=>i.cancel())}getMapUpdates(){const t=[...this.mapUpdates];return this.mapUpdates=[],t}addMapUpdate(t){this.mapUpdates.push(t),vt(t)}}class U{inventory={};limit;total;hook;constructor(t,i){this.hook=t,this.limit=i,this.total=0}add(t,i=1){this.limit&&(i=Math.max(0,Math.min(this.limit-this.total,i))),i&&(this.total+=i,this.inventory[t]=(this.inventory[t]??0)+i,this.hook?.(t,i))}remove(t,i=1){return(this.inventory[t]??0)>=i?(this.inventory[t]=this.inventory[t]-i,this.total-=i,this.hook?.(t,-i),this.inventory[t]||delete this.inventory[t],!0):!1}}const w=(e,t,i)=>Math.max(e,Math.min(t,i)),Tt=10,J=-3,tt="ENTITY_SELECTED";class Rt{camera=[0,0];actions;zoom=0;selectedEntity;inventory;entities=[];story={};history=[];onStory;entityHook;constructor(t=new _t,i=new U,o){this.actions=t,this.inventory=i,this.onStory=o,this.entityHook=new EventTarget}selectEntity(t){this.entities.find(i=>i.id===t)&&(this.selectedEntity=t,this.entityHook.dispatchEvent(new CustomEvent(tt,{detail:t})))}resolution(t){const i=t.canvas.height/t.canvas.width,o=t.canvas.width+100*this.zoom,r=t.canvas.height+100*this.zoom*i;return[o,r]}setZoom(t){const i=w(J,Tt,t);if(i>this.zoom)this.camera[0]=this.camera[0]-d,this.camera[1]=this.camera[1]-d;else if(i<this.zoom)this.camera[0]=this.camera[0]+d,this.camera[1]=this.camera[1]+d;else return;this.zoom=i}getHistory(){return this.history=this.history.slice(-F).toReversed().filter((t,i,o)=>o.indexOf(t)===i).reverse(),this.history}addWaypoint(t){this.story[t]||(this.story[t]=!0,this.onStory?.(t))}}const n=new Rt;let p,R=document.getElementById("c");const b=document.querySelector("#control_console input");let v=F;const bt=()=>{R?.addEventListener("mousedown",e=>{p=[e.clientX,e.clientY]}),R?.addEventListener("mousemove",e=>{if(p){let t=[e.clientX,e.clientY];const o=.6+(n.zoom+(0-J))*.125,r=(t[0]-(p?.[0]??0))*o,s=(t[1]-(p?.[1]??0))*o;n.camera[0]=n.camera[0]-r,n.camera[1]=n.camera[1]+s,p=t}}),R?.addEventListener("mouseup",()=>p=void 0),R?.addEventListener("mouseout",()=>p=void 0),R?.addEventListener("wheel",e=>{const t=e.deltaY;n.setZoom(n.zoom+(t>0?1:-1))}),b?.addEventListener("keyup",e=>{const t=e.key,i=e.target.value;if(t==="Enter"&&i.length){n.history.push(i),wt(i),e.target.value="";const o=n.getHistory();v=Math.min(o.length,F)}if(t==="ArrowUp"&&v>0){const o=n.getHistory();v--,b.value=o[v]??""}if(t==="ArrowDown"){const o=n.getHistory();v>=o.length?b.value="":(v++,b.value=o[v]??"")}}),b?.focus(),document.querySelector("#nav > div:first-of-type")?.addEventListener("click",e=>et(e.target,"control_console"))},et=(e,t)=>{Array.from(document.querySelectorAll("div#context > div")).forEach(i=>i.classList.add("hidden")),Array.from(document.querySelectorAll("#nav > div")).forEach(i=>i.classList.remove("active")),document.getElementById(t)?.classList.remove("hidden"),e.classList.add("active")},At=`
...
${e.join(`
`)}
`)},Wt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;h(`
SELECTED
=========

${e?`[${e.id}] - ${e.type}`:"- NONE -"}
`)},Ht=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return E("No entity selected");h(`
COMMANDS
=========
...
`)}
`)},Xt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return E("No entity selected");h(`
INVENTORY
==========
...
`)}
`)},Gt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return E("No entity selected");h(`Entity [${e.id}] battery: ${e.battery} / 100`)},Vt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return E("No entity selected");h(`
INSTALLED MODULES
==================
...
`)},gt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(i=>i.id===n.selectedEntity):void 0;if(!e)return E("No entity selected");const t=n.actions.cancelOneForEntity(e.id);t&&h(`Entity [${e.id}] request to cancel ${t.type}`)},zt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return E("No entity selected");n.actions.cancelAllForEntity(e.id),h(`Entity [${e.id}] cancel all queued actions`)},jt=e=>{if(!n.story.STORAGE_FIRST)return;if(e?.trim())return C[e]?Mt(e):(E(`Unknown recipe: ${e}`),!0);const t=Object.entries(C).filter(([,i])=>(i.story??[]).every(o=>n.story[o])).filter(([,i])=>!i.waypoint||!n.story[i.waypoint]).map(([i,o])=>`${i}
${o.description}
