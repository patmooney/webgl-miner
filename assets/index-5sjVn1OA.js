...
${e.join(`
`)}
`)},Pt=()=>{const e=o.selectedEntity!==void 0?o.entities.find(t=>t.id===o.selectedEntity):void 0;h(`
SELECTED
=========

${e?`[${e.id}] - ${e.type}`:"- NONE -"}
`)},$t=()=>{const e=o.selectedEntity!==void 0?o.entities.find(t=>t.id===o.selectedEntity):void 0;if(!e)return m("No entity selected");h(`
COMMANDS
=========

${e.actions.map(t=>` - ${jt[t]}`).join(`
`)}
`)},gt=()=>{h(`
STORAGE
========
...
`)}
`)},kt=()=>{const e=o.selectedEntity!==void 0?o.entities.find(t=>t.id===o.selectedEntity):void 0;if(!e)return m("No entity selected");o.focusEntity(e.id)},Wt=()=>{const e=o.selectedEntity!==void 0?o.entities.find(t=>t.id===o.selectedEntity):void 0;if(!e)return m("No entity selected");h(`
INVENTORY
==========
...
`)}
`)},Ht=()=>{const e=o.selectedEntity!==void 0?o.entities.find(t=>t.id===o.selectedEntity):void 0;if(!e)return m("No entity selected");h(`Entity [${e.id}] battery: ${e.battery} / 100`)},Yt=()=>{const e=o.selectedEntity!==void 0?o.entities.find(t=>t.id===o.selectedEntity):void 0;if(!e)return m("No entity selected");h(`
INSTALLED MODULES
==================
...
`),!0},jt={MINE:"mine <n=1>      - Activate drill <n> times.",MOVE:"move <n=1>      - Move <n> in facing direction.",RECHARGE:"recharge <n?>   - Recharge entity battery <n> units. HOME ONLY.",ROTATE:"rotate <-3|3=1> - Rotate 90 degrees CW <n> or CCW <-n>.",UNLOAD:"unload          - Move entity inventory to storage. HOME ONLY."},qt=2,Kt=1,Zt=2e3,Qt=function(e){if(e.isStarted||(e.timeEnd=Date.now()+Zt/this.drillSpeed,e.start()),e.timeEnd>Date.now())return;e.complete();const t=J(x(this.coords),this.angle,1);if(t.type===f.ROCK||t.type===f.ORE){let i=t.durability*k[t.tile];i-=Kt;const n=mt(t),r=ut[t.tile]??[];for(let s of r){let a=s.chance?s.chance:(s.baseChance??0)*(n*.2);for(;a>0;)Math.random()<=a&&this.inventory.add(s.item),a-=1}if(i<=0){const s=ft(t.coord);o.actions.addMapUpdate({...t,type:f.FLOOR,durability:1});for(let a of s)if(a.type===f.SHADOW){let c=f.ROCK;Math.random()<.01*n&&(c=f.ORE),o.actions.addMapUpdate({...a,type:c,durability:1})}}else o.actions.addMapUpdate({...t,durability:i/k[t.tile]})}},J=(e,t,i=1)=>{const n=[...e];return t===0?n[0]+=i:t===1?n[1]-=i:t===2?n[0]-=i:t===3&&(n[1]+=i),v(n)},Jt=Object.freeze(Object.defineProperty({__proto__:null,BATTERY_COST:qt,command:Qt,getFacingTile:J},Symbol.toStringTag,{value:"Module"})),te=1,ee=d/100,ie=function(e){if(!e.isStarted){const r=oe(1,this.angle,this.coords);this.angle===3&&(this.target=[this.coords[0],this.coords[1]+r*d]),this.angle===0&&(this.target=[this.coords[0]+r*d,this.coords[1]]),this.angle===1&&(this.target=[this.coords[0],this.coords[1]-r*d]),this.angle===2&&(this.target=[this.coords[0]-r*d,this.coords[1]]),e?.start()}const t=ee;let i;this.target&&(i=[U(-t,t,this.target[0]-this.coords[0]),U(-t,t,this.target[1]-this.coords[1])]),i?.[0]===0&&i?.[1]===0&&(o.updateLights(),e?.complete(),this.target=void 0,i=void 0),i&&(o.isFollowing===this.id&&(o.camera[0]+=i[0],o.camera[1]+=i[1]),this.coords=[this.coords[0]+i[0],this.coords[1]+i[1]])},oe=(e,t,i)=>{let n=[0,0];t===N.DOWN?n=[0,-d]:t===N.LEFT?n=[-d,0]:t===N.RIGHT?n=[d,0]:n=[0,d];let r=0,s=[...i];for(;r<e;){s[0]+=n[0],s[1]+=n[1];const a=x(s),c=v(a);if(!lt[c.tile])break;r++}return r},ne=Object.freeze(Object.defineProperty({__proto__:null,BATTERY_COST:te,command:ie},Symbol.toStringTag,{value:"Module"})),re=1,se=function(e){let t=this.targetR;if(e.isStarted||(t=this.angle+(e.value>0?1:-1),t<0&&(t=4+t),t>3&&(t=t-4),e.start()),t===void 0){e.complete();return}this.targetR=t;const i=F[this.targetR];let n=0;if(e.value<0){let r=this.rad<i?this.rad+g:this.rad;n=-.05,r+n<=i&&e.complete()}else{let r=this.rad>i?this.rad-g:this.rad;n=.05,r+n>=i&&e.complete()}e.isComplete?(this.rad=F[this.targetR],this.angle=this.targetR,this.targetR=void 0):this.rad+=n,this.rotation[0]=Math.sin(this.rad),this.rotation[1]=Math.cos(this.rad)},ae=Object.freeze(Object.defineProperty({__proto__:null,BATTERY_COST:re,command:se},Symbol.toStringTag,{value:"Module"})),ce=0,de=function(e){e.complete();const t=x(this.coords);v(t).type===f.HOME?(Object.entries(this.inventory.inventory).forEach(([n,r])=>{o.inventory.add(n,r),this.inventory.remove(n,r)}),G(this.id,"Unloading")):G(this.id,"Unable to unload")},le=Object.freeze(Object.defineProperty({__proto__:null,BATTERY_COST:ce,command:de},Symbol.toStringTag,{value:"Module"})),ue=0,V=1e3,he=function(e){if(!e.isStarted){const i=x(this.coords);if(v(i).type!==f.HOME){m(`Entity [${this.id}] - Unable to recharge at this location`),e.complete();return}e.timeEnd=Date.now()+V,e.start()}if(e.timeEnd>Date.now())return;const t=e.value?Math.max(0,Math.min(100,e.value))/100*this.maxBattery:this.maxBattery;if(this.battery>=t||e.shouldCancel){e.complete();return}this.battery++,e.timeEnd=Date.now()+V},fe=Object.freeze(Object.defineProperty({__proto__:null,BATTERY_COST:ue,command:he},Symbol.toStringTag,{value:"Module"})),me=function(e){if(!this.actions.includes(e.type)){e.complete();return}let t;switch(e.type){case"MOVE":t=ne;break;case"ROTATE":t=ae;break;case"MINE":t=Jt;break;case"UNLOAD":t=le;break;case"RECHARGE":t=fe;break}if(t){if(!e.isStarted){if(t.BATTERY_COST){if(this.battery<t.BATTERY_COST)return;this.battery=Math.max(0,this.battery-t.BATTERY_COST)}Ft(this,e)}return t.command.call(this,e)}};class tt{id;type;gfx;actions;rotation=[0,1];rad=F[3];angle=3;inventorySize;inventory;speed;drillSpeed;battery;maxBattery;target;targetR;coords;modules;constructor(t,i,n,r=["MOVE","ROTATE"],s){this.gfx=t,this.id=i,this.coords=[Math.round(u/2*d)-d/2,Math.round(u/2*d)-d/2],this.rotation[0]=Math.sin(this.rad),this.rotation[1]=Math.cos(this.rad),this.actions=r,this.type=n,this.maxBattery=0,this.battery=this.maxBattery,this.speed=0,this.drillSpeed=0,this.inventorySize=0,this.inventory=new P(void 0,this.inventorySize),this.modules=s??[]}async init(){this.balanceModules(),this.battery=this.maxBattery}installModule(t){const i=w[t];return!i||this.modules.find(n=>w[n]?.type===i.type)?!1:(this.modules.push(t),this.balanceModules(),!0)}balanceModules(){this.speed=0,this.drillSpeed=0,this.maxBattery=0,this.inventorySize=0,this.modules.forEach(t=>{const i=w[t]?.stats;this.speed+=i?.speed??0,this.maxBattery+=i?.battery??0,this.drillSpeed+=i?.drillSpeed??0,this.inventorySize+=i?.inventorySize??0}),this.inventory.limit=this.inventorySize}update(t){const i=this.battery;t&&me.call(this,t),this.battery!==i&&(this.battery<=0?m(`Entity ${this.id} - no power, battery empty`):this.battery<=this.maxBattery*.2&&i>this.maxBattery*.2?Nt(`Entity ${this.id} - battery low warning`):this.battery<=this.maxBattery*.1&&i>this.maxBattery*.1&&m(`Entity ${this.id} - battery is critical`))}render(t,i){this.gfx.render(t,this,i)}}function et(e){console&&(console.error?console.error(e):console.log&&console.log(e))}const Ee=/ERROR:\s*\d+:(\d+)/gi;function it(e,t=""){const i=[...t.matchAll(Ee)],n=new Map(i.map((r,s)=>{const a=parseInt(r[1]),c=i[s+1],l=c?c.index:t.length,E=t.substring(r.index,l);return[a-1,E]}));return e.split(`
`).map((r,s)=>{const a=n.get(s);return`${s+1}: ${r}${a?`

^^^ ${a}`:""}`}).join(`
`)}function ye(e,t,i,n){const r=n||et,s=e.createShader(i);if(!s)return r("No shader"),null;if(e.shaderSource(s,t),e.compileShader(s),!e.getShaderParameter(s,e.COMPILE_STATUS)){const c=e.getShaderInfoLog(s);return r(`Error compiling shader: ${c}
${it(t,c??"")}`),e.deleteShader(s),null}return s}function pe(e,t,i,n,r){const s=r||et,a=e.createProgram();if(!a)return null;if(t.forEach(function(l){e.attachShader(a,l)}),i&&i.forEach(function(l,E){e.bindAttribLocation(a,n?n[E]:E,l)}),e.linkProgram(a),!e.getProgramParameter(a,e.LINK_STATUS)){const l=e.getProgramInfoLog(a),E=t.map(y=>{const at=it(e.getShaderSource(y)??"");return`${e.getShaderParameter(y,e.SHADER_TYPE)}:
${at}`}).join(`
`);return s(`Error in program linking: ${l}
${E}`),e.deleteProgram(a),null}return a}const ve=["VERTEX_SHADER","FRAGMENT_SHADER"];function ot(e,t,i=[],n=[],r=()=>{}){const s=[];for(let a=0;a<t.length;++a)s.push(ye(e,t[a],e[ve[a]],r));return pe(e,s.filter(Boolean),i,n,r)}function nt(e,t){t=t||1;const i=e.clientWidth*t|0,n=e.clientHeight*t|0;return e.width!==i||e.height!==n?(e.width=i,e.height=n,!0):!1}let C={};const rt=async(e,t)=>{if(C[t])return C[t];const i=e.createTexture()??void 0;if(!i)throw new Error("Invalid texture");e.bindTexture(e.TEXTURE_2D,i);const n=new Image;return n.src=t,new Promise(r=>{n.onload=()=>{e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,n),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.bindTexture(e.TEXTURE_2D,null),C[t]=i,r(i)}})},_e=`#version 300 es
