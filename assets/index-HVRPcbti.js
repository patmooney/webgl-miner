...
}`;function z(e){console&&(console.error?console.error(e):console.log&&console.log(e))}const dt=/ERROR:\s*\d+:(\d+)/gi;function X(e,t=""){const i=[...t.matchAll(dt)],o=new Map(i.map((r,s)=>{const a=parseInt(r[1]),c=i[s+1],l=c?c.index:t.length,E=t.substring(r.index,l);return[a-1,E]}));return e.split(`
...
${X(t,c??"")}`),e.deleteShader(s),null}return s}function ut(e,t,i,o,r){const s=r||z,a=e.createProgram();if(!a)return null;if(t.forEach(function(l){e.attachShader(a,l)}),i&&i.forEach(function(l,E){e.bindAttribLocation(a,o?o[E]:E,l)}),e.linkProgram(a),!e.getProgramParameter(a,e.LINK_STATUS)){const l=e.getProgramInfoLog(a),E=t.map(y=>{const nt=X(e.getShaderSource(y)??"");return`${e.getShaderParameter(y,e.SHADER_TYPE)}:
${nt}`}).join(`
`);return s(`Error in program linking: ${l}
${E}`),e.deleteProgram(a),null}return a}const ht=["VERTEX_SHADER","FRAGMENT_SHADER"];function G(e,t,i=[],o=[],r=()=>{}){const s=[];for(let a=0;a<t.length;++a)s.push(lt(e,t[a],e[ht[a]],r));return ut(e,s.filter(Boolean),i,o,r)}function g(e,t){t=t||1;const i=e.clientWidth*t|0,o=e.clientHeight*t|0;return e.width!==i||e.height!==o?(e.width=i,e.height=o,!0):!1}const j=async(e,t)=>{const i=e.createTexture()??void 0;if(!i)throw new Error("Invalid texture");e.bindTexture(e.TEXTURE_2D,i);const o=new Image;return o.src=t,new Promise(r=>{o.onload=()=>{e.texImage2D(e.TEXTURE_2D,0,e.RGBA,e.RGBA,e.UNSIGNED_BYTE,o),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_S,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_WRAP_T,e.CLAMP_TO_EDGE),e.texParameteri(e.TEXTURE_2D,e.TEXTURE_MIN_FILTER,e.LINEAR),e.bindTexture(e.TEXTURE_2D,null),r(i)}})},q=""+new URL("atlas-BxrVKyxQ.png",import.meta.url).href,d=40,u=200,ft=6,R=1/ft,S=2,U=10,M={RIGHT:0,LEFT:2,DOWN:1},x={0:0*Math.PI/180,1:90*Math.PI/180,2:180*Math.PI/180,3:270*Math.PI/180},P=360*Math.PI/180,$={FLOOR:0,ROCK:10,ORE:100,SHADOW:0,HOME:0},mt={FLOOR:!0,ROCK:!1,ORE:!1,SHADOW:!1,HOME:!0},f={FLOOR:0,ROCK:1,SHADOW:3,HOME:4,ORE:5},Et={ROCK:[{item:"stone",chance:.5},{item:"iron",baseChance:.02}],ORE:[{item:"stone",chance:.01},{item:"iron",baseChance:.05},{item:"copper",baseChance:.02},{item:"carbon",baseChance:.01}]},yt=e=>Object.entries(f).find(([,t])=>t===e)?.[0]??"FLOOR",K=()=>{const e=u/2-4,t=u/2+4,i=u/2-2,o=u/2+2;let r=[];for(let s=0;s<u*u;s++){const a=s%u,c=Math.floor(s/u);if(c>i&&c<o&&a>i&&a<o){r.push(f.HOME,1);continue}if(c>e&&c<t&&a>e&&a<t){r.push(f.FLOOR,1);continue}if((c===e||c===t)&&a>=e&&a<=t){r.push(f.ROCK,1);continue}if((a===e||a===t)&&c>=e&&c<=t){r.push(f.ROCK,1);continue}r.push(f.SHADOW,1)}return new Float32Array(r)},p=e=>{const[t,i]=e,o=i*u+t,r=O().at(o*S),s=O().at(o*S+1)??0;if(r===void 0)throw new Error(`Invalid tile ${t} / ${i}`);return{coord:e,tile:yt(r),type:r,durability:s}},I=e=>[Math.round(e[0]/d),Math.round(e[1]/d)],pt=e=>{const t=[],[i,o]=e;return i>0&&t.push(p([i-1,o])),i<u-1&&t.push(p([i+1,o])),o>0&&t.push(p([i,o-1])),o<u-1&&t.push(p([i,o+1])),t},vt=e=>{const t=u/2;return Math.round(Math.sqrt(Math.pow(e.coord[0]-t,2)+Math.pow(e.coord[1]-t,2)))};let w;const O=()=>(w||(w=K()),w),_t=e=>{const t=O(),[i,o]=e.coord,r=o*u+i;t[r*S]=e.type,t[r*S+1]=e.durability},Z="ACTION_ADD",Q="ACTION_REMOVE";class k{id;type;delta;value;timeEnd;entityId;parentId;isSilent=!1;isComplete=!1;isStarted=!1;isCancelled=!1;shouldCancel=!1;constructor(t,{delta:i,value:o,timeEnd:r,entityId:s},a=!1,c){this.type=t,this.delta=i,this.value=o,this.timeEnd=r,this.entityId=s,this.id=crypto.randomUUID(),this.isSilent=a,this.parentId=c,this.type==="ROTATE"&&(this.value=Math.max(Math.min(3,this.value??0),-3)),this.type==="MOVE"&&(this.value=Math.max(0,Math.min(u,o??0)))}complete(){this.isComplete=!0}start(){this.isStarted=!0}cancel(){this.isStarted?this.shouldCancel=!0:this.isCancelled=!0}}class Tt{stack;mapUpdates;hook;constructor(){this.stack=[],this.mapUpdates=[],this.hook=new EventTarget}getActions(){return this.stack.filter(i=>i.isComplete).forEach(i=>{this.hook.dispatchEvent(new CustomEvent(Q,{detail:i}))}),this.stack=[...this.stack.filter(i=>!i.isComplete&&!i.isCancelled)],this.stack}addAction(t,{delta:i,value:o,timeEnd:r,entityId:s}){const a=new k(t,{delta:i,value:o,timeEnd:r,entityId:s});return this.stack.push(a),this.hook.dispatchEvent(new CustomEvent(Z,{detail:a})),a}addSilentAction(t,{delta:i,value:o,timeEnd:r,entityId:s},a){const c=new k(t,{delta:i,value:o,timeEnd:r,entityId:s},!0,a);this.stack.push(c)}cancelOneForEntity(t){const i=this.stack.find(r=>r.entityId===t);if(!i)return;const o=this.stack.filter(r=>r.parentId===i.id);return[i,...o].forEach(r=>r.cancel()),i}cancelAllForEntity(t){this.stack.filter(i=>i.entityId===t).forEach(i=>i.cancel())}getMapUpdates(){const t=[...this.mapUpdates];return this.mapUpdates=[],t}addMapUpdate(t){this.mapUpdates.push(t),_t(t)}}class B{inventory={};limit;total;hook;constructor(t,i){this.hook=t,this.limit=i,this.total=0}add(t,i=1){this.limit&&(i=Math.max(0,Math.min(this.limit-this.total,i))),i&&(this.total+=i,this.inventory[t]=(this.inventory[t]??0)+i,this.hook?.(t,i))}remove(t,i=1){return(this.inventory[t]??0)>=i?(this.inventory[t]=this.inventory[t]-i,this.total-=i,this.hook?.(t,-i),this.inventory[t]||delete this.inventory[t],!0):!1}}const C=(e,t,i)=>Math.max(e,Math.min(t,i)),Rt=10,J=-3,tt="ENTITY_SELECTED";class bt{camera=[0,0];actions;zoom=0;selectedEntity;inventory;isFollowing;entities=[];story={};history=[];onStory;entityHook;constructor(t=new Tt,i=new B,o){this.actions=t,this.inventory=i,this.onStory=o,this.entityHook=new EventTarget}selectEntity(t){this.focusEntity(t)&&(this.selectedEntity=t,this.entityHook.dispatchEvent(new CustomEvent(tt,{detail:t})))}focusEntity(t){const i=this.entities.find(o=>o.id===t);return i?(this.isFollowing=t,this.camera=[i.coords[0]-8.5*d,i.coords[1]-6.5*d],this.zoom=0,!0):!1}resolution(t){const i=t.canvas.height/t.canvas.width,o=t.canvas.width+100*this.zoom,r=t.canvas.height+100*this.zoom*i;return[o,r]}setZoom(t){const i=C(J,Rt,t);if(i>this.zoom)this.camera[0]=this.camera[0]-d,this.camera[1]=this.camera[1]-d;else if(i<this.zoom)this.camera[0]=this.camera[0]+d,this.camera[1]=this.camera[1]+d;else return;this.zoom=i}getHistory(){return this.history=this.history.slice(-U).toReversed().filter((t,i,o)=>o.indexOf(t)===i).reverse(),this.history}addWaypoint(t){this.story[t]||(this.story[t]=!0,this.onStory?.(t))}}const n=new bt;let v,b=document.getElementById("c");const A=document.querySelector("#control_console input");let _=U;const At=()=>{b?.addEventListener("mousedown",e=>{v=[e.clientX,e.clientY]}),b?.addEventListener("mousemove",e=>{if(v){n.isFollowing=void 0;let t=[e.clientX,e.clientY];const o=.6+(n.zoom+(0-J))*.125,r=(t[0]-(v?.[0]??0))*o,s=(t[1]-(v?.[1]??0))*o;n.camera[0]=n.camera[0]-r,n.camera[1]=n.camera[1]+s,v=t}}),b?.addEventListener("mouseup",()=>v=void 0),b?.addEventListener("mouseout",()=>v=void 0),b?.addEventListener("wheel",e=>{const t=e.deltaY;n.setZoom(n.zoom+(t>0?1:-1))}),A?.addEventListener("keyup",e=>{const t=e.key,i=e.target.value;if(t==="Enter"&&i.length){n.history.push(i),Ct(i),e.target.value="";const o=n.getHistory();_=Math.min(o.length,U)}if(t==="ArrowUp"&&_>0){const o=n.getHistory();_--,A.value=o[_]??""}if(t==="ArrowDown"){const o=n.getHistory();_>=o.length?A.value="":(_++,A.value=o[_]??"")}}),A?.focus(),document.querySelector("#nav > div:first-of-type")?.addEventListener("click",e=>et(e.target,"control_console"))},et=(e,t)=>{Array.from(document.querySelectorAll("div#context > div")).forEach(i=>i.classList.add("hidden")),Array.from(document.querySelectorAll("#nav > div")).forEach(i=>i.classList.remove("active")),document.getElementById(t)?.classList.remove("hidden"),e.classList.add("active")},St=`
...
`,Ot=()=>{const e=document.getElementById("nav"),t=document.getElementById("context"),i=document.createElement("div");i.textContent="Control";const o=document.createElement("div");if(o.id="control_control",o.classList.add("hidden"),o.innerHTML=St,i.addEventListener("click",()=>et(i,"control_control")),e?.appendChild(i),t?.appendChild(o),Mt(o),wt(),n.selectedEntity!==void 0){const r=n.actions.getActions().filter(s=>s.entityId===n.selectedEntity&&!s.isSilent);W(r)}n.actions.hook.addEventListener(Z,r=>{const s=r;s.detail.entityId===n.selectedEntity&&it(s.detail)}),n.actions.hook.addEventListener(Q,r=>{const s=r;s.detail.entityId===n.selectedEntity&&It(s.detail)}),n.entityHook.addEventListener(tt,r=>{const s=r;Array.from(document.querySelectorAll("#interface_control > div:first-child > div")).forEach(l=>l.classList.remove("active")),document.querySelector(`#interface_control > div:first-child > div[data-id="${s.detail}"]`)?.classList.add("active");const c=n.actions.getActions().filter(l=>l.entityId===n.selectedEntity&&!l.isSilent);W(c)})},W=e=>{const t=document.querySelector("#interface_control > div:last-child");if(t){t.innerHTML="";for(let i of e)it(i,t)}},it=(e,t)=>{t=t??document.querySelector("#interface_control > div:last-child")??void 0;const i=document.createElement("div");i.textContent=`${e.type} - ${e.value}`,i.dataset.id=e.id,t?.appendChild(i)},It=e=>{const t=document.querySelector("#interface_control > div:last-child")??void 0;t&&t.querySelector(`div[data-id="${e.id}"]`)?.remove()},Mt=e=>{const[t,i,o,r,s,a,c,l,E]=Array.from(e.querySelectorAll("button"));i.addEventListener("click",()=>{if(n.selectedEntity!==void 0){n.actions.addAction("MOVE",{value:5,entityId:n.selectedEntity});for(let y=1;y<5;y++)n.actions.addSilentAction("MOVE",{value:1,entityId:n.selectedEntity})}}),t.addEventListener("click",()=>{n.selectedEntity!==void 0&&n.actions.addAction("MOVE",{value:1,entityId:n.selectedEntity})}),o.addEventListener("click",()=>{n.selectedEntity!==void 0&&n.actions.addAction("ROTATE",{value:-1,entityId:n.selectedEntity})}),r.addEventListener("click",()=>{n.selectedEntity!==void 0&&n.actions.addAction("ROTATE",{value:1,entityId:n.selectedEntity})}),s.addEventListener("click",()=>{n.selectedEntity!==void 0&&n.actions.addAction("MINE",{value:0,entityId:n.selectedEntity})}),a.addEventListener("click",()=>{if(n.selectedEntity!==void 0){n.actions.addAction("MINE",{value:5,entityId:n.selectedEntity});for(let y=1;y<5;y++)n.actions.addSilentAction("MINE",{value:1,entityId:n.selectedEntity})}}),c.addEventListener("click",()=>{n.selectedEntity!==void 0&&n.actions.addAction("UNLOAD",{value:0,entityId:n.selectedEntity})}),l.addEventListener("click",()=>{n.selectedEntity!==void 0&&n.actions.addAction("RECHARGE",{value:100,entityId:n.selectedEntity})}),E.addEventListener("click",()=>{n.selectedEntity!==void 0&&n.focusEntity(n.selectedEntity)})},wt=()=>{const e=document.querySelector("#interface_control > div:first-child")??void 0;e&&n.entities.forEach(t=>{const i=document.createElement("div");i.dataset.id=t.id.toString(),i.textContent=`[${t.id}] ${t.type}`,e.appendChild(i),i.addEventListener("click",()=>n.selectEntity(t.id))})},N={module_basic_battery:{type:"battery",stats:{battery:100}},module_basic_drill:{type:"drill",stats:{drillSpeed:1}},module_basic_motor:{type:"engine",stats:{speed:1}},module_basic_store:{type:"store",stats:{inventorySize:10}},module_dev:{type:"battery",stats:{battery:1e4,drillSpeed:20,speed:10,inventorySize:1e3}}},D={stone:"Stone",iron:"Iron ore",carbon:"Carbon",copper:"Copper",module_visual_scanner:"Visual Scanner",module_basic_battery:"Basic Battery",module_basic_drill:"Basic Drill",module_basic_motor:"Basic Motor",module_basic_store:"Basic Store",deployable_mining_hull:"Mining Automation Hull",module_home_navigation:"Home Navigation Module",coal:"Coal",module_dev:"DEV DEV DEV"},F={VISUAL_SCAN_MODULE:{ingredients:[{item:"iron",count:10}],story:["IRON_FIRST"],description:"Visually assess one tile in front",type:"MODULE",item:"module_visual_scanner"},CONTROL_INTERFACE:{ingredients:[{item:"stone",count:50},{item:"iron",count:10}],story:["IRON_FIRST"],description:"Extra control interface for manual remote instruction",type:"INTERFACE",waypoint:"INTERFACE_CONTROL_INTERFACE"},AUTOMATION_INTERFACE:{ingredients:[{item:"stone",count:50},{item:"iron",count:10},{item:"copper",count:10},{item:"carbon",count:10}],story:["IRON_FIRST","CARBON_FIRST","COPPER_FIRST"],description:"Allow automated remote instruction",type:"INTERFACE",waypoint:"INTERFACE_AUTOMATION_INTERFACE"},BASIC_BATTERY_MODULE:{ingredients:[{item:"stone",count:20},{item:"iron",count:10}],story:["IRON_FIRST"],description:"A very simple battery with limited capacity",type:"MODULE",item:"module_basic_battery"},BASIC_DRILL_MODULE:{ingredients:[{item:"iron",count:30}],story:["IRON_FIRST"],description:"A brittle, dull drill",type:"MODULE",item:"module_basic_drill"},BASIC_MOTOR_MODULE:{ingredients:[{item:"stone",count:20},{item:"iron",count:50}],story:["IRON_FIRST"],description:"5hp of pure disappointment",type:"MODULE",item:"module_basic_motor"},MINING_AUTOMATION_HULL:{ingredients:[{item:"iron",count:10}],story:["IRON_FIRST"],description:"An empty mining automation hull (deployable)",type:"DEPLOYABLE",item:"deployable_mining_hull"},HOME_NAVIGATION_MODULE:{ingredients:[{item:"carbon",count:10},{item:"copper",count:10}],story:["CARBON_FIRST","COPPER_FIRST"],description:"Provides automated routing to nearest base",type:"MODULE",item:"module_home_navigation"},SMELTING_INTERFACE:{ingredients:[{item:"iron",count:50},{item:"stone",count:200}],story:["IRON_FIRST"],description:"For the production of alloy metals",type:"INTERFACE",waypoint:"INTERFACE_SMELTING"}},Nt=e=>{n.story.STORAGE_FIRST||n.addWaypoint("STORAGE_FIRST"),e==="iron"&&!n.story.IRON_FIRST&&n.addWaypoint("IRON_FIRST"),e==="carbon"&&!n.story.CARBON_FIRST&&n.addWaypoint("CARBON_FIRST"),e==="copper"&&!n.story.COPPER_FIRST&&n.addWaypoint("COPPER_FIRST")},Lt=e=>{const t=F[e];if(!t)return!1;for(let i of t.ingredients)if((n.inventory.inventory[i.item]??0)<i.count)return!1;for(let i of t.ingredients)n.inventory.remove(i.item,i.count);return t.type==="MODULE"?n.inventory.add(t.item):t.type==="INTERFACE"&&n.addWaypoint(t.waypoint),!0},xt=e=>{switch(e){case"STORAGE_FIRST":T(`Crafting Unlocked
see command "crafting" for more information`);break;case"IRON_FIRST":T("New recipes available");break;case"CARBON_FIRST":n.story.COPPER_FIRST&&T("New recipes available");break;case"COPPER_FIRST":n.story.CARBON_FIRST&&T("New recipes available");break;case"INTERFACE_CONTROL_INTERFACE":T("Control interface installed"),H();break;case"INTERFACE_AUTOMATION_INTERFACE":T("Automation interface installed"),H();break}},H=()=>{Ot()},L=document.querySelector("#control_console div#output"),Ct=e=>{h(" "),h(` > ${e}`);const[t,i]=e.split(" "),o=t.toLowerCase(),r=Bt(o,i);if(r===!1){m("Invalid argument");return}else if(r)return;const s=Ut(o,i);if(s===!1){m("No entity selected!");return}else if(s)return;m(`Unknown command: ${o}`)},Ft=e=>{h(`[WARNING] ${e}`,"warning")},m=e=>{h(`[ERROR] ${e}`,"error")},Ut=(e,t)=>{const i=n.selectedEntity!==void 0?n.entities.find(r=>r.id===n.selectedEntity):void 0;if(!i)return;const o=r=>{const s=parseInt(t??0),a=n.actions.addAction(r,{entityId:i.id,timeEnd:Date.now()+1e5,value:s});if(r==="MOVE"||r==="ROTATE"||r==="MINE")for(let c=1;c<(a.value??s);c++)n.actions.addSilentAction(r,{entityId:i.id,timeEnd:Date.now()+1e5,value:s},a.id);return!0};if(i.actions.includes(e.toUpperCase()))return o(e.toUpperCase())},Bt=(e,t)=>{switch(e){case"help":return Wt(),!0;case"list":return kt(),!0;case"selected":return Ht(),!0;case"commands":return Yt(),!0;case"storage":return Vt(),!0;case"inventory":return Xt(),!0;case"battery":return Gt(),!0;case"cancel":return jt(),!0;case"halt":return qt(),!0;case"select":return Dt(parseInt(t));case"crafting":return Kt(t);case"modules":return gt(),!0;case"focus":return zt(),!0;default:return}},Dt=e=>isNaN(e)||!n.entities.find(i=>i.id===e)?!1:(n.selectEntity(e),h(`Entity ${e} selected`),!0),Pt=(e,t)=>{!t||t.isSilent||h(`[${(Date.now()/1e3).toFixed(0)}] Entity [${e.id}] - ${t.type}: ${t.value}`,"log")},Y=(e,t)=>{h(`[ENTITY:${e}] ${t}`)},h=(e,t)=>{e.split(`
`).map(i=>{const o=document.createElement("p");o.textContent=i||"",t&&(o.className=t),L?.appendChild(o)}),L?.scrollTo(0,L.scrollHeight??0)},T=e=>{h(e,"important")},$t=()=>{T(`Welcome
========
...
${e?`[${e.id}] - ${e.type}`:"- NONE -"}
`)},Yt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return m("No entity selected");h(`
COMMANDS
=========
...
${Object.entries(n.inventory.inventory).map(([e,t])=>`${D[e]} - ${t}`).join(`
`)}
`)},zt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return m("No entity selected");n.focusEntity(e.id)},Xt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return m("No entity selected");h(`
INVENTORY
==========
Slots: ${e.inventory.total} / ${e.inventory.limit??"-"}

${Object.entries(e.inventory.inventory).map(([t,i])=>`${D[t]} - ${i}`).join(`
`)}
`)},Gt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return m("No entity selected");h(`Entity [${e.id}] battery: ${e.battery} / 100`)},gt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return m("No entity selected");h(`
INSTALLED MODULES
==================

${e.modules.map(t=>` - ${D[t]}`).join(`
`)}

[ Movement: ${e.speed} ] [ Drill: ${e.drillSpeed} ] [ Battery: ${e.battery} / ${e.maxBattery} ]
`)},jt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(i=>i.id===n.selectedEntity):void 0;if(!e)return m("No entity selected");const t=n.actions.cancelOneForEntity(e.id);t&&h(`Entity [${e.id}] request to cancel ${t.type}`)},qt=()=>{const e=n.selectedEntity!==void 0?n.entities.find(t=>t.id===n.selectedEntity):void 0;if(!e)return m("No entity selected");n.actions.cancelAllForEntity(e.id),h(`Entity [${e.id}] cancel all queued actions`)},Kt=e=>{if(!n.story.STORAGE_FIRST)return;if(e?.trim())return F[e]?Lt(e):(m(`Unknown recipe: ${e}`),!0);const t=Object.entries(F).filter(([,i])=>(i.story??[]).every(o=>n.story[o])).filter(([,i])=>!i.waypoint||!n.story[i.waypoint]).map(([i,o])=>`${i}
${o.description}
